                    ...
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false">
                                <i class="mdi mdi-content-copy"></i><span class="hide-menu">Master </span></a>
                            <ul aria-expanded="false" class="collapse first-level">
                                <li class="sidebar-item">
                                    <a href="{{ route('masteruser-index') }}" class="sidebar-link">
                                        <i class="mdi mdi-format-align-left"></i><span class="hide-menu">
                                            Master User
                                        </span></a>
                                </li>
                                <li class="sidebar-item">
                                    <a href="{{ route('masterrole-index') }}" class="sidebar-link"><i class="mdi mdi-format-align-right"></i><span class="hide-menu">
                                            Master Role
                                        </span></a>
                                </li>
                                <li class="sidebar-item">
                                    <a href="{{ route('masterabsen-index') }}" class="sidebar-link">
                                        <i class="mdi mdi-format-float-left">
                                        </i><span class="hide-menu"> Master Absen </span></a>
                                </li>
                            </ul>
                        </li>
                        <li class="sidebar-item">
                            <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false">
                                <i class="mdi mdi-bookmark-plus-outline"></i><span class="hide-menu">Ticket </span></a>
                            <ul aria-expanded="false" class="collapse first-level">
                                <li class="sidebar-item">
                                    <a href="{{ route('form-index') }}" class="sidebar-link"><i class="mdi mdi-book-multiple">
                                        </i><span class="hide-menu"> Form Ticket </span></a>
                                </li>
                                <li class="sidebar-item">
                                    <a href="{{ route('list-index') }}" class="sidebar-link"><i class="mdi mdi-book-plus">
                                        </i><span class="hide-menu"> Ticket List </span></a>
                                </li>
                            </ul>
                        </li>
                        <li class="sidebar-item">
        ...
        <div class="page-wrapper">
            ...
            <div class="row page-titles">
                <div class="col-md-5 col-12 align-self-center">
                    <h3 class="text-themecolor mb-0">Basic</h3>
