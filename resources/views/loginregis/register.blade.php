...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('loginregis/assets/images/favicon.png')}}" />
    <!-- Custom CSS -->
    <link href="{{ asset('loginregis/dist/css/style.min.css')}}" rel="stylesheet" />
...
<body>
    ...
    <!-- All Required js -->
    <!-- -------------------------------------------------------------- -->
    <script src="{{ asset('loginregis/assets/libs/jquery/dist/jquery.min.js ')}}"></script>
    <!-- Bootstrap tether Core JavaScript -->
    <script src="{{ asset('loginregis/assets/libs/bootstrap/dist/js/bootstrap.bundle.min.j')}}s"></script>
    <!-- -------------------------------------------------------------- -->
    <!-- This page plugin js -->
    <!-- -------------------------------------------------------------- -->
    <!--Custom JavaScript -->
