...
<head>
    ...
    <title>AbsenEdu-Landing Page</title>
    <!-- <meta content="" name="description"> -->
    <!-- <meta content="" name="keywords"> -->

    <!-- Favicons -->
    <!-- <link href="{{ asset('halutama/assets/img/favicon.png')}}" rel="icon"> -->
    <!-- <link href="{{ asset('halutama/assets/img/apple-touch-icon.png')}}" rel="apple-touch-icon"> -->

    <!-- Google Fonts -->
    <link href="https://fonts.googleapis.com/css?family=Open+Sans:300,300i,400,400i,600,600i,700,700i|Raleway:300,300i,400,400i,500,500i,600,600i,700,700i|Poppins:300,300i,400,400i,500,500i,600,600i,700,700i" rel="stylesheet">

    <!-- Vendor CSS Files -->
    <link href="{{ asset('halutama/assets/vendor/aos/aos.css')}}" rel="stylesheet">
    <link href="{{ asset('halutama/assets/vendor/bootstrap/css/bootstrap.min.css')}}" rel="stylesheet">
    <link href="{{ asset('halutama/assets/vendor/bootstrap-icons/bootstrap-icons.css')}}" rel="stylesheet">
    <link href="{{ asset('halutama/assets/vendor/boxicons/css/boxicons.min.css')}}" rel="stylesheet">
    <link href="{{ asset('halutama/assets/vendor/glightbox/css/glightbox.min.css')}}" rel="stylesheet">
    <link href="{{ asset('halutama/assets/vendor/swiper/swiper-bundle.min.css')}}" rel="stylesheet">

    <!-- Template Main CSS File -->
    <link href="{{ asset('halutama/assets/css/style.css')}}" rel="stylesheet">
...
<body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-6 d-lg-flex flex-lg-column justify-content-center align-items-stretch pt-5 pt-lg-0 order-2 order-lg-1" data-aos="fade-up">
                    <div>
                        <h1>Welcome to ABSENEDU</h1>
                        <h2>Hadirkan Kemudahan, Absen yang Efisien!</h2>

                    </div>
                </div>
                <div class="col-lg-6 d-lg-flex flex-lg-column align-items-stretch order-1 order-lg-2 hero-img" data-aos="fade-up">
                    <img src="{{ asset('halutama/assets/img/3.png')}}" class="img-fluid" alt="">
                </div>
            </div>
        </div>
    ...
    <main id="main">
            ...
            <div class="container">
                ...
                <div class="row no-gutters">
                        ...
                        <div class="content d-flex flex-column justify-content-center">
                            <div class="row">
                                <div class="col-md-6 icon-box" data-aos="fade-up">
                                    ...
                                    <h4>Manajemen Absensi yang Efisien</h4>
                                    <p>Kelola kehadiran guru dengan mudah dan efisien.AbsenEdu memberikan solusi terbaik untuk mencatat,
                                        memantau, dan menganalisis kehadiran guru secara akurat.</p>
                                </div>
                                <div class="col-md-6 icon-box" data-aos="fade-up" data-aos-delay="100">
                                    <i class="bx bx-bell"></i>
                                    <h4>Notifikasi Absensi Otomatis</h4>
                                    <p>Dapatkan pemberitahuan otomatis setiap kali ada guru yang tidak hadir.
                                        Sistem notifikasi AbsenEdu membantu memastikan bahwa Anda tetap up-to-date tentang kehadiran guru.</p>
                                </div>
                                <div class="col-md-6 icon-box" data-aos="fade-up" data-aos-delay="200">
                                    <i class="bx bx-time-five"></i>
                                    <h4>Riwayat Absensi yang Terkelola</h4>
                                    <p>Akses riwayat absensi dengan mudah.
                                        AbsenEdu menyediakan catatan lengkap kehadiran guru,
                                        mempermudah pemantauan dan pelaporan, serta membantu dalam analisis jangka panjang</p>
                                </div>
                    ...
                    <div class="image col-xl-5 d-flex align-items-stretch justify-content-center order-1 order-lg-2" data-aos="fade-left" data-aos-delay="100">
                        <img src="{{ asset('halutama/assets/img/2.png')}}" class="img-fluid" alt="">
                    </div>
                </div>
            ...
            <div class="container">
                ...
                <div class="row content">
                    <div class="col-md-4" data-aos="fade-right">
                        <img src="{{ asset('halutama/assets/img/details-1.png')}}" class="img-fluid" alt="">
                    </div>
                ...
                <div class="row content">
                    <div class="col-md-4 order-1 order-md-2" data-aos="fade-left">
                        <img src="{{ asset('halutama/assets/img/details-2.png')}}" class="img-fluid" alt="">
                    </div>
                ...
                <div class="row content">
                    <div class="col-md-4" data-aos="fade-right">
                        <img src="{{ asset('halutama/assets/img/details-3.png')}}" class="img-fluid" alt="">
                    </div>
                ...
                <div class="row content">
                    <div class="col-md-4 order-1 order-md-2" data-aos="fade-left">
                        <img src="{{ asset('halutama/assets/img/details-4.png')}}" class="img-fluid" alt="">
                    </div>
                    <div class="col-md-8 pt-5 order-2 order-md-1" data-aos="fade-up">
        ...
        <section id="gallery" class="gallery">
            <div class="container" data-aos="fade-up">
                ...
                <div class="section-title">
                    <h2>Gallery</h2>
                    <p>Anda dapat menambahkan foto-foto sekolah yang menggunakan website ini.</p>
                </div>
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                <img src="{{ asset('halutama/assets/img/testimonials/testimonials-1.jpg')}}" class="testimonial-img" alt="">
                                <h3>Saul Goodman</h3>
                                <h4>Ceo &amp; Founder</h4>
                                <p>
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                <img src="{{ asset('halutama/assets/img/testimonials/testimonials-2.jpg')}}" class="testimonial-img" alt="">
                                <h3>Sara Wilsson</h3>
                                <h4>Designer</h4>
                                <p>
                                    <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                <img src="{{ asset('halutama/assets/img/testimonials/testimonials-3.jpg')}}" class="testimonial-img" alt="">
                                <h3>Jena Karlis</h3>
                                <h4>Store Owner</h4>
                                <p>
                                    <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                <img src="{{ asset('halutama/assets/img/testimonials/testimonials-4.jpg')}}" class="testimonial-img" alt="">
                                <h3>Matt Brandon</h3>
                                <h4>Freelancer</h4>
                                <p>
                                    <i class="bx bxs-quote-alt-left quote-icon-left"></i>
                        ...
                        <div class="swiper-slide">
                            <div class="testimonial-item">
                                <img src="{{ asset('halutama/assets/img/testimonials/testimonials-5.jpg')}}" class="testimonial-img" alt="">
                                <h3>John Larson</h3>
                                <h4>Entrepreneur</h4>
                                <p>
                                    <i class="bx bxs-quote-alt-left quote-icon-left"></i>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 footer-contact">
                        <h3>AbsenEdu</h3>
                        <p>
                            Jl. Cililitan Besar <br>
                            Jakarta Timur <br>
                            <br>
                            <strong>Phone:</strong> +62 895 1885 3375<br>
                            <strong>Email:</strong> fthira.sal@gmail.com<br>
                        </p>
                    </div>
    ...
    <!-- Vendor JS Files -->
    <script src="{{ asset('halutama/assets/vendor/aos/aos.js')}}"></script>
    <script src="{{ asset('halutama/assets/vendor/bootstrap/js/bootstrap.bundle.min.js')}}"></script>
    <script src="{{ asset('halutama/assets/vendor/glightbox/js/glightbox.min.js')}}"></script>
    <script src="{{ asset('halutama/assets/vendor/swiper/swiper-bundle.min.js')}}"></script>
    <script src="{{ asset('halutama/assets/vendor/php-email-form/validate.js')}}"></script>

    <!-- Template Main JS File -->
    <script src="{{ asset('halutama/assets/js/main.js')}}"></script>
