        ...
        <div class="card-header">
            <div class="d-flex justify-content-between align-items-center">
                <div class="float-left">
                    <h3 class="card-title">Master Absen</h3>
                </div>
            ...
            <table class="table table-bordered table-hover text-center" id="masterTablebody">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <button class="btn mr-2" style="background-color: #6E98B8;" onclick="editAbsen('{{$absen->idAbsen}}')"><i class=" fa fa-edit"></i></button>
                            <button class="btn" style="background-color: #F4B24E;" id="btn-delete-post" data-id="{{ $absen->idAbsen }}"><i class=" fa fa-trash"></i></button>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editModalLabel">Absen Form</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form id="formMasterAbsen">
                    @csrf
