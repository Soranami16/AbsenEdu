            ...
            <table class="table table-bordered table-hover text-center" id="masterTablebody">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $role->namaRole}}</td>
                        <td>
                            <button class="btn mr-2" style="background-color: #6E98B8;" onclick="editRole('{{$role->idRole}}')"><i class=" fa fa-edit"></i></button>
                            <button class="btn" style="background-color: #F4B24E;" id="btn-delete-post" data-id="{{ $role->idRole }}"><i class=" fa fa-trash"></i></button>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
